...
function App() {
  ...
  const handleSendMessage = async () => {
    ...
    setMessages((prevMessages) => [
      ...prevMessages,
      { id: typingMessageId, text: "Please wait a moment...", sender: 'bot' },
    ]);
    ...
    try {
      ...
      const apiKey = "AIzaSyA2XIgCIk_6ntdjDA_Dpz41uNpgFVY0CpQ";
  ...
  return (
    <div className="d-flex justify-content-center align-items-center min-vh-100 bg-light p-3">
      <div className="card shadow-lg" style={{ maxWidth: '500px', width: '100%', height: '550px', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="card-body overflow-auto flex-grow-1 d-flex flex-column">
          {messages.map((msg) => (
